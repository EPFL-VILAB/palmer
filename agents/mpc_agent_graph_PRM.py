...
class GraphMemory():
    ...
    def set_latent_distances(self, num_batches=100):
    ...
    def render_stitched_path(self, path):
        
        if path[0] == 'start':
            path_positions = [self.start_position] + self.positions_block[path[1:-1]].tolist() + [self.goal_position]
